const { Member, Role, GameClass, Event, Group, GroupMember, EventSignup } = require('./index')
...
async function loadSeeds() {
  try {
    ...
    await Event.bulkCreate([
      {
        event_name: 'ТВ Атака',
        banner_url: '/events/gildwar.jpg',
        is_active: true,
        start_date: new Date('2025-05-25T22:01:00+02:00').toISOString(),
        commentary: 'Сбор в 21:30',
        opponent: 'Imbalance',
      },
      {
        event_name: 'ТВ Защита',
        banner_url: '/events/gildwar.jpg',
        is_active: true,
        start_date: new Date('2025-05-25T22:05:00+02:00').toISOString(),
        commentary: 'Сбор в 22:15',
        opponent: 'Фришка',
      },
      {
        event_name: 'ТВ Защита',
      ...
      {
        event_name: 'Садэман',
        banner_url: '/events/sademan.jpg',
        is_active: true,
        start_date: new Date('2025-05-24T22:00:00+02:00').toISOString(),
        commentary: 'Сбор в 21:30',
      },
    ], { ignoreDuplicates: true })

    await Group.bulkCreate([
      { event_id: 1, group_name: 'Атака 1', leader_id: 1 },
      { event_id: 1, group_name: 'Атака 2', leader_id: 2 },
      { event_id: 2, group_name: 'Защита 1', leader_id: 3 },
      { event_id: 5, group_name: 'Садэман Группа 1', leader_id: 4 },
    ], { ignoreDuplicates: true })

    await EventSignup.bulkCreate([
      { member_id: 1, event_id: 1, status: true },
      { member_id: 2, event_id: 1, status: true },
      { member_id: 3, event_id: 2, status: false },
      { member_id: 4, event_id: 5, status: true },
      { member_id: 5, event_id: 5, status: true },
    ], { ignoreDuplicates: true })

    await GroupMember.bulkCreate([
      { member_id: 1, group_id: 1, event_id: 1 },
      { member_id: 2, group_id: 1, event_id: 1 },
      { member_id: 4, group_id: 4, event_id: 5 },
      { member_id: 5, group_id: 4, event_id: 5 },
    ], { ignoreDuplicates: true })
